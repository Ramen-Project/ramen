...
export class TestFramework {
    ...
    async runUnitTests(): Promise<void> {
        ...
        // Test ResourceManager - REMOVED (no longer used, functionality in DIContainer)
    ...
    async runIntegrationTests(): Promise<void> {
        ...
        await this.test('Backend - local connection lifecycle', async () => {
            const { BackendConnectionFactory } = await import(
                '../extension/backend/backendInterface'
            );
            const { LocalBackendProvider, LocalBackendConnection } = await import(
                '../extension/backend/localBackend'
            );
    ...
    async runPerformanceTests(): Promise<void> {
        ...
        // Test resource management performance - REMOVED (ResourceManager no longer used)
