...
export class RamenLanguageServer {
    ...
    private getServerModule(): string | undefined {
        ...
        // Development path
        const devPath = path.join(this.context.extensionPath, 'src', 'server', 'languageServer.ts');
    ...
    private registerCodeActions(): void {
        ...
        const provider = vscode.languages.registerCodeActionsProvider(this.documentSelector, {
            provideCodeActions(
