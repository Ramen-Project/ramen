...
export class RamenGraphProvider implements vscode.TreeDataProvider<GraphItem> {
    private _onDidChangeTreeData: vscode.EventEmitter<GraphItem | undefined | null | void> = new vscode.EventEmitter<GraphItem | undefined | null | void>();
    readonly onDidChangeTreeData: vscode.Event<GraphItem | undefined | null | void> = this._onDidChangeTreeData.event;
